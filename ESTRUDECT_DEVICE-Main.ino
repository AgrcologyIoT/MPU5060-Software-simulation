/*
MPU9250 SOFTWARE BY AHMED ATEF 
VERSION:0.1
NOTE:
  Hardware setup:
  ---------------
...
static const u1_t PROGMEM DEVEUI[8]={ 0x3E, 0xA8, 0x04, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
...
static const u1_t PROGMEM APPKEY[16] = { 0x03, 0x85, 0xB7, 0x8B, 0x6B, 0x21, 0xFC, 0x27, 0x41, 0x6D, 0x14, 0x2C, 0x1D, 0x84, 0xE3, 0x61 };
...
/*const lmic_pinmap lmic_pins = {
    ...
    .rst = 5,//RFM Reset
    .dio = {2, 3,LMIC_UNUSED_PIN}, //RFM Interrupt, RFM LoRa pin, RFM LoRa pin
};*/
//
const lmic_pinmap lmic_pins = {
    .nss = 10,//RFM Chip Select
    .rxtx = LMIC_UNUSED_PIN,
    .rst = 9,//RFM Reset
    .dio = {8, 6,7}, //RFM Interrupt, RFM LoRa pin, RFM LoRa pin
};
...
//          sprintf(myStr, "Counter-%dahmed%d", counter,155); 
        read_mpu9250_data();
        delay(100);
        String stringOne =String(therm.object(), 3);
        //temp
        myStr[0]='t';
        myStr[1]='e';
        myStr[2]='m';
        ...
        myStr[11]='w';
        myStr[12]=':';
        String stringOne_0 =String(yaw, 3);
        myStr[13]=stringOne_0[0];
        myStr[14]=stringOne_0[1];
        myStr[15]=stringOne_0[2];
        myStr[16]=stringOne_0[3];
        //
                //yaw
        myStr[9]='r';
        myStr[10]='o';
        myStr[11]='l';
        myStr[12]=':';
        String stringOne_1 =String(roll, 3);
        myStr[13]=stringOne_1[0];
        myStr[14]=stringOne_1[1];
        myStr[15]=stringOne_1[2];
        myStr[16]=stringOne_1[3];
         //pitch
        myStr[17]='p';
        myStr[18]='i';
        myStr[19]='t';
         myStr[20]='c';
          myStr[21]='h';
        myStr[22]=':';
        String stringOne_2 =String(pitch, 3);
        myStr[23]=stringOne_2[0];
        myStr[24]=stringOne_2[1];
        myStr[25]=stringOne_2[2];
        myStr[26]=stringOne_2[3];
                //yaw
        myStr[27]='y';
        myStr[28]='a';
        myStr[29]='w';
        myStr[30]=':';
        String stringOne_3 =String(yaw, 3);
        myStr[31]=stringOne_3[0];
        myStr[32]=stringOne_3[1];
        myStr[33]=stringOne_3[2];
        myStr[34]=stringOne_3[3];
        //end
        myStr[35]='E';
        myStr[36]='N';
        myStr[37]='D';
        ...
        LMIC_setTxData2(1, myStr, sizeof(myStr)-1, 0);
        SerialUSB.println(("Packet queued"));
...
//PROCESSING 
 ...
 // temperatures.
  // They'll be floats, calculated out to the unit you set with setUnit().
    SerialUSB.print("Object: " + String(therm.object(), 2));
    SerialUSB.write('°'); // Degree Symbol
    SerialUSB.println("F");
    SerialUSB.print("Ambient: " + String(therm.ambient(), 2));
    SerialUSB.write('°'); // Degree Symbol
    SerialUSB.println("F");
    SerialUSB.println();
  }
